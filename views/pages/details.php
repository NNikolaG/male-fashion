                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="product__details__option">
                            ...
                            <div class="product__details__option__size">
                                ...
                                foreach ($velicine as $velicina) :
                                    ...
                                    <label for="<?= $velicina->velicina ?>"><?= $velicina->velicina ?>
                                        ...
                                        <input type="radio" id="<?= $velicina->velicina ?>" name="velicine"
                                               value="<?= $velicina->velicina ?>">
                            ...
                            <div class="product__details__option__color">
                                ...
                                foreach ($boje as $boja) :
                                    ...
                                    <a class='round'
                                       href="index.php?page=details&prod=<?= $_GET['prod'] ?>&color=<?= $boja->idBoja ?>"
                                       style="background-color: <?= $boja->rgb ?>">
                            ...
                            <i class="fas fa-question-circle ml-5"
                               title="First select color, when page reloads select size and quantity then ADD TO CART"></i>
                        ...
                        <div class="product__details__cart__option">
                            ...
                            if (isset($_SESSION['admin'])) :
                                ...
                                <a id="edit" class="primary-btn" href="index.php?page=panel&edit=<?= $_GET['prod'] ?>"
                                   style="color:beige">Edit Product</a>
                                                ...
                                                <form id="reviewForm">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-12">
                                                            ...
                                                            <input type="hidden" id="produkt"
                                                                   value="<?php echo $_GET['prod'] ?>">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-sm-6">
                    ...
                    <div class="product__item">
                        ...
                        <div class="product__item__pic set-bg"
                             data-setbg="assets/img/product/<?= $product->nazivSlike ?>">
                            ...
                            <ul class="product__hover">
                                ...
                                <li>
                                    ...
                                    <a href="index.php?page=details&prod=<?= $product->idProdukt ?>"><img
